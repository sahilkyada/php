  ...
  if (empty($_REQUEST['title']) ||  empty($_REQUEST['description']) || empty($_REQUEST['icon']))  {
    ...
    if ($conn) {
      ...
      if(isset($_REQUEST['update_id'])){
        ...
        $q = "UPDATE services SET title='$title', description='$description', icon='$icon' WHERE id=$id";
      }
      else{
        $q = "INSERT INTO services(title, description, icon) VALUES('$title','$description','$icon')";
      }
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Service</a> <a href="#" class="current">Add Service</a> </div>
    <h1>Add Service</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <form method="POST" class="form-horizontal" enctype="multipart/form-data">
             ...
             <div class="control-group">
                ...
                <input type="submit" name="submit" class="btn btn-success" value="<?php if(isset($id)){ echo "Update service"; } else{ echo "Add service"; } ?>">
                </div>
              </div>
