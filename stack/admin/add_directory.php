...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Directory Handling</a> <a href="#" class="current">Add Directory</a> </div>
    <h1>Add Directory / File</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            ...
            <div class="control-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Enter Directory Path">
                    <input type="submit" name="submit" class="btn btn-success" value="Add Directory">
                </div>
                </div>
