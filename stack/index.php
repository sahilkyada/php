...
<?php
  ...
  if ($conn) {
    ...
    $feature_sq = "SELECT * FROM features ORDER BY id DESC LIMIT 3";    
    $service_sq = "SELECT * FROM services ORDER BY id DESC LIMIT 6";    
    $team_sq = "SELECT * FROM team ORDER BY id DESC LIMIT 4";    
    $pricing_sq = "SELECT * FROM pricing ORDER BY id LIMIT 3";    
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12 padding-none feature-bg">
            ...
            <?php
              ...
              if($res = mysqli_query($conn, $feature_sq)){
                ...
                while($fres = mysqli_fetch_assoc($res)){
                  ...
                  $f_id = $fres['id']; 
                  $f_title = $fres['title']; 
                  $f_description = $fres['description']; 
                  $f_icon = $fres['icon']; 

                  echo " <div class='feature-item wow fadeInDown' data-wow-duration='1000ms' data-wow-delay='300ms'>
                  <div class='icon'>
                    <i class='$f_icon'></i>
                  </div>
    ...
    <section id="services" class="section-padding bg-gray">
      <div class="container">
        ...
        <?php
              ...
              if($res = mysqli_query($conn, $service_sq)){
                ...
                while($fres = mysqli_fetch_assoc($res)){
                  ...
                  $s_id = $fres['id']; 
                  $s_title = $fres['title']; 
                  $s_description = $fres['description']; 
                  $s_icon = $fres['icon']; 

                  echo "<div class='col-md-6 col-lg-4 col-xs-12'>
                    <div class='services-item wow fadeInRight' data-wow-delay='0.3s'>
                      <div class='icon'>
                        <i class='$s_icon'></i>
                      </div>
                      <div class='services-content'>
                        <h3><a href='#'>$s_title</a></h3>
                        <p>$s_description</p>
                      </div>
                    </div>
                  </div>";
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
            <div class="video-promo-content text-center wow fadeInUp" data-wow-delay="0.3s">
              <a href="https://www.youtube.com/watch?v=dnV1gYZONMA" class="video-popup"><i class="lni-film-play"></i></a>
    ...
    <section id="team" class="section-padding text-center">
      <div class="container">
        ...
        <?php
              ...
              if($res = mysqli_query($conn, $team_sq)){
                  ...
                  <div class='col-sm-6 col-md-6 col-lg-3'>
                    ...
                    <div class='team-item text-center wow fadeInRight' data-wow-delay='0.3s'>
                      <div class='team-img'>
                        ...
                        <img class='img-fluid' src='admin/$t_pic' alt='' />
    ...
    <section id="pricing" class="section-padding bg-gray">
      <div class="container">
        ...
        <?php
            ...
            if($res = mysqli_query($conn, $pricing_sq)){
              ...
              while($fres = mysqli_fetch_assoc($res)){
                ...
                $p_plan = $fres['plan']; 
                $p_price = $fres['price']; 
                $p_description = $fres['description']; 
                  ...
                  <div class='col-lg-4 col-md-6 col-xs-12'>
                    <div class='table wow fadeInLeft' data-wow-delay='1.2s'>
                      ...
                      <div class='pricing-header'>
                        <p class='price-value'>$$p_price<span>/ Month</span></p>
                      </div>
